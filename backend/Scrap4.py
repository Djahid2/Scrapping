...
url_site1 = 'https://www.lipton-fit.com/blog/detection-de-la-fraude-financiere-par-lintelligence-artificielle-une-approche-par-lincertitude'
...
def translate_to_english(text):
    ...
    return text  # Retourner le texte d'origine en cas d'échec

if response.status_code == 200 : 
    response.encoding = 'utf-8'
    soup = BeautifulSoup(response.text, 'html.parser')
    elements = soup.find('div',{'data-w-id' : '6b860a2d-6220-a604-c767-3f71a8f2e542'})
