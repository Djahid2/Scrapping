...
@admin.register(ThesisData)
class ThesisDataAdmin(admin.ModelAdmin):
    list_display = ('info','Scrap_statique_data')
    search_fields = ('info', 'Scrap_statique_data')
    list_filter = ('Scrap_statique_data',)