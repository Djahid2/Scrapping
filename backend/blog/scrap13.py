...
url_site1 = "https://towardsdatascience.com/fraud-prediction-with-machine-learning-in-financial-industry-a-data-scientists-experience-b3ffc32d27cc"
...
if response.status_code == 200 : 
    ...
    article = soup.find_all('div',class_="ci")
    print(len(article))
    elements = article[1]
   ...
   # Vérifier qu'il y a au moins deux éléments
    ...
    def scrap():
        ...
        custom_date = date(2024, 6, 7)    # Afficher ou traiter les résultats
