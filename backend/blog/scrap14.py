...
url_site1 = "https://www.piranirisk.com/academy/pirani-explains/the-most-shocking-cases-of-financial-fraud"
...
if response.status_code == 200 : 
    ...
    title = soup.find('h1')
    article = soup.find_all('div',class_="rtext__content clear normal-text")
    print(len(article))
    elements = article[0]
